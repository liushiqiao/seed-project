...
import com.xh.lesson.constants.ProjectConstant;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://122.51.36.141:3306/company_frame";
    ...
    public static void main(String[] args) {
        genCode(new String[]{"t_company"},new String[]{"Company"});
